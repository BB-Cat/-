...
namespace ImGui
{
    ...
    //static inline bool  DragFloat3(const char* label, Vector3D v, float v_speed, float v_min, float v_max, const char* format, float power) { return DragScalarN(label, ImGuiDataType_Float, v, 3, v_speed, &v_min, &v_max, format, power); }
