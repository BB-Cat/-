...
MyConstantBuffer::MyConstantBuffer(void* buffer, UINT size_buffer, RenderSystem* system) : m_system(system)
{
...
void MyConstantBuffer::update(DeviceContextPtr context, void* buffer)
{
