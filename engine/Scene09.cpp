...
Scene09::Scene09(SceneManager* sm) : Scene(sm)
{
	...
	CameraManager::get()->setCamPos(Vec3(5.263f, -25.73f, -53.54f));
	CameraManager::get()->setCamRot(Vec2(-0.7314f, -3.9449f));
	...
	m_global_light_rotation = Vec2(2.6f, 1.0f);
	m_global_light_strength = 0.85f;
	m_light_color = Vec3(1.0, 0.58, 0.39);
	...
	m_cloud_props.m_cloud_position = Vec3(78, 25, 60);
	...
	m_cloud_props.m_move_dir = Vec3(0.06, 0, 0);
...
void Scene09::imGuiRender()
{
	...
	if (ImGui::CollapsingHeader("Cloud Settings"))
	{
		...
		ImGui::SliderFloat("Texture Resolution", v.setArray(), 5.0f, 10.0f);
...
void Scene09::mainRenderPass(float delta)
{
	...
	m_sky->renderMesh(delta, Vec3(700, 700, 700), CameraManager::get()->getCamera().getTranslation(), Vec3(0, 0, 0), Shaders::WEATHER_ATMOSPHERE, false);
